...
// needed since a synchonized motion in progress will not be paused
int tpIsPaused(TP_STRUCT * const tp) 
{
    TC_STRUCT *tc;
    ...
    //if the machine is still moving, then itś not actually paused yet
    if (emcmotStatus->current_vel > TP_VEL_EPSILON) {
